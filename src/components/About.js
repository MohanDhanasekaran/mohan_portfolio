      ...
      <div className="flex flex-col px-10 items-center gap-20 lg:flex-row ">
        ...
        <div className="max-w-lg text-center lg:text-justify">
          ...
          <p className="text-gray-500 text-lg">
           I'm a Junior Front-End Developer with a strong foundation in the MERN Stack. Skilled in HTML, CSS, JavaScript, Bootstrap, ReactJS, Node.js, Express.js, and MongoDB. I’m eager to apply my knowledge to real-world projects, contribute to innovative development teams, and continuously grow as a full-stack developer. 💻
          </p>
        </div>
      </div>
    </div>
